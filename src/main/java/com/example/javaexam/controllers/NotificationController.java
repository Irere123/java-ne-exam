...
/** Notifications produced by the database routines (Task 6). JWT required. */
@RestController
@RequestMapping("/api/notifications")
@RequiredArgsConstructor
@Tag(name = "Notifications", description = "View notifications generated by database triggers (Task 6)")
